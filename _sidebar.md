...
- **🧩 Reference**
  ...
  - [expectBody](reference/expectBody.md)
  - [expectBodyContains](reference/expectBodyContains.md)
  - [expectCookies](reference/expectCookies.md)
  - [expectCookiesLike](reference/expectCookiesLike.md)
  - [expectError](reference/expectError.md)
  - [expectJson](reference/expectJson.md)
  - [expectJsonLength](reference/expectJsonLength.md)
  - [expectJsonLike](reference/expectJsonLike.md)
  - [expectJsonMatch](reference/expectJsonMatch.md)
  - [expectJsonSchema](reference/expectJsonSchema.md)
  - [expectJsonSnapshot](reference/expectJsonSnapshot.md)
  - [expectResponseTime](reference/expectResponseTime.md)
