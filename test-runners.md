...
The whole documentation will be using **mocha** as the test runner. See [pactum-cucumber-boilerplate](https://github.com/pactumjs/pactum-cucumber-boilerplate) for a working example on running pactum with **cucumber**.
